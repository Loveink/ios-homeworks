...
//  Navigation
//
//  Created by Александра Савчук on 07.11.2022.
//
...
class OpenPostViewController: UIViewController {
    ...
    private func setupView() {
        ...
        stackViewPost.addArrangedSubview(imageView)
    ...
    @objc func tapLiked(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        for i in 0...arrayOfposts.count - 1 {
            if arrayOfposts[i].id == selectedId {
                arrayOfposts[i].likes += 1
                likesLabel.text = "Likes: " + String(arrayOfposts[i].likes)
